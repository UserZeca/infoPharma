...
const EnhancedTableToolbar = (props) => {
    ...
    const remove = (objetoCategoria) =>{
      ...
      produtosRepository.deleteProduto(objetoCategoria)
      .then((res)=>{        
          alert(`Sucesso ao remover produto ${objetoCategoria.titulo}`);
            
          return res;
      })
      .catch(err =>{    
        alert(`Erro ao remover ${objetoCategoria.titulo}`);
        console.log(err);
      })
    }
    ...
    const update = (objetoCategoria, previusData) =>{
      ...
      produtosRepository.updateProduto({
          id: previusData.id,
          nome: objetoCategoria.nome == '' ? previusData.nome : objetoCategoria.nome,
          subcategoria: objetoCategoria.subcategoria == '' ? previusData.subcategoria : objetoCategoria.subcategoria,
          preco: objetoCategoria.preco == '' ? parseFloat(previusData.preco) : parseFloat(objetoCategoria.preco) ,
          url: objetoCategoria.url == '' ? previusData.url : objetoCategoria.url,
          emPromocao: objetoCategoria.emPromocao,
      })
      .then((res)=>{        
          alert(`Sucesso ao atualizar produto:  ${previusData.titulo} id[{${previusData.id}}]` )  
          return res;
      })
      .catch(err =>{    
        alert(`Erro ao atualizar categoria ${previusData.titulo} id[{${previusData.id}}`);
        console.log(err);
      })
    }
              ...
              <Tooltip title="Remover">
                  <IconButton 
                      ...
                      onClick={() => { 
                          ...
                          history.push('/update-remove/produto'); 
                          history.go();
                        }
                      }>
                      <DeleteIcon />
                  ...
                  <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                    ...
                    <DialogContent>
                        ...
                        <TextField
                            ...
                            name="subcategoria"
                            label="Subcategoria"
                            placeholder={previusData.subcategoria}
                            type="text"
                            fullWidth
                        />
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.subcategoria}</TableCell>
                      <TableCell align="left">{row.preco}</TableCell>
                      <TableCell align="left">{row.url}</TableCell>                      
                      <TableCell align="left">
                        {row.emPromocao == true? 'sim' : 'não'} 
                      </TableCell>
                    </TableRow>
                  );
                })}
